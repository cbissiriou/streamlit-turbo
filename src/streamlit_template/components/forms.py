...
from ..core import COMMON_VALIDATORS, validate_form_data
...
class FormBuilder:
    ...
    def __init__(self, form_key: str, title: str | None = None):
    ...
    def add_section(self, title: str, description: str | None = None):
